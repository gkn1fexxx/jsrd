...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                MY LIFE MY WORLD<br>
                <div style="font-size:1.5rem; font-weight:normal;">HACK</div>
            </div>
            <button id="restart" class="mainbtn"><span class="iconfont">&#xe6a7;</span>GOGOGO</button>
                    ...
                    .forEach(talent=>{
                        ...
                        li.click(()=>{
                            if(li.hasClass('selected')) {
                                ...
                                // if(this.#talentSelected.size==11) {
                                //     this.hint('只能选11个天赋');
                                //     return;
                                // }
